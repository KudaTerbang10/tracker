...
- When the user specifies exactly which UI element(s) to change, only modify those specific elements — do not change related/neighboring elements (icons, colors, chips) unless explicitly requested. Confidence: 0.75
