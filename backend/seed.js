...
async function seed() {
  try {
    ...
    const cabangs = await Cabang.insertMany([
      ...
      { kode: 'BDB', name: 'Bandung Holis', address: 'Jl. Taman Holis Indah, Ruko Blok D 18, Cigondewah Kidul, Bandung', phone: '(022)-6024661', kota: 'Bandung', lokasi: { type: 'Point', coordinates: [107.5641846912176, -6.940450102065132] } },
      ...
      { kode: 'SKH', name: 'Sukoharjo', address: 'Jl. Raya Grogol No. 23, Dusun II, Madegondo, Kec. Grogol, Kab. Sukoharjo 57157', phone: '0811-2696-516', kota: 'Sukoharjo', lokasi: { type: 'Point', coordinates: [110.82061332336494, -7.596816149739666] } },
