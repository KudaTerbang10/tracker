...
async function seed() {
  try {
    ...
    const cabangs = await Cabang.insertMany([
      { kode: "TNG", name: "() Selatan", address: "Jl. Serpong km. 8, Pakulonan, Tangerang Selatan 15325", phone: "(021)-5396529", kota: "Tangerang", lokasi: { type: 'Point', coordinates: [106.64749884908083, -6.241551497744919] } },
      ...
      { kode: "JLM", name: "Jakarta Jelambar", address: "Jl. Penerangan No. 51, Jelambar Kec. Grogol, Jakarta Barat 11460", phone: "(021)-6570758", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.78148650398197, -6.163837918354764] } },
      ...
      { kode: "MGB", name: "Jakarta Mangga Besar", address: "Jl. Mangga Besar 4 M No. 50, Kec. Taman Sari, Jakarta Barat 11150", phone: "(021)-6590993", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.82294482334265, -6.153090557608883] } },
      { kode: "JTN", name: "Jakarta Jatinegara", address: "Pintu Masuk Gedung Parkir Pasar Jatinegara, Jl. Raya Jatinegara Barat, Jakarta Timur 13320", phone: "(021)-8519589", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.8626969554434, -6.215017573487658] } },
      { kode: "KHM", name: "Jakarta Mas Mansyur", address: "Jl. KH. Mas Mansyur No. 15D, Kec. Tanah Abang, Jakarta Pusat 10240", phone: "(021)-1905815", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.81531862766444, -6.190548975646167] } },
      ...
      { kode: "JBB", name: "Jakarta Bojong Raya", address: "Jl. Bojong Raya No. 97, Rawa Buaya, Cengkareng, Jakarta Barat 11740", phone: "(021)-5814326", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.7333458890681, -6.170877313027029] } },
      { kode: "PGB", name: "Jakarta Pulo Gebang", address: "Jl. Komarudin Lama 107 Pulo Gebang, Cakung, Jakarta Timur 13950", phone: "(021)-86608630 / (021)-8606523", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.94312072334316, -6.194103195178223] } },
      { kode: "KKC", name: "Jakarta Kebon Kacang", address: "Jl. Kebon Kacang 1 (Pusat Grosir Metro Tanah Abang, Pintu Keluar Kebon Kacang 1), Jakarta Pusat 10240", phone: "0858-4293-6780 / 0878-9667-5446", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.8161058362081, -6.188017815956004] } },
      { kode: "MGD", name: "Jakarta Mangga Dua", address: "ITC Mangga Dua Raya, Lantai Dasar Blok E1 No. 12, Jl. Mangga Dua Raya, Jakarta Utara 14430", phone: "(021)-62300314", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.8249254521777, -6.135866648532799] } },
      { kode: "ALY", name: "Jakarta Alaydrus", address: "Jl. Alaydrus No. 16, Petojo Utara, Kec. Gambir, Jakarta Pusat 10130", phone: "(021)-63868028", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.81394263520701, -6.164560667744887] } },
      { kode: "ASM", name: "Jakarta Asemka", address: "Pusat Grosir Asemka, Pasar Pagi, Parkir Mobil Lantai Dasar, Jakarta Barat 11110", phone: "08112696716", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.81200729450707, -6.140202082721924] } },
      ...
      { kode: "TAB", name: "Tanah Abang", address: "Lobby Barat Blok B Pasar Tanah Abang, Jakarta Pusat", phone: "0858-4293-6780 / 0878-9667-5446", kota: "Jakarta", lokasi: { type: 'Point', coordinates: [106.81455616664564, -6.1881149778320035] } },
