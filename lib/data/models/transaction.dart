...
class Transaction {
  ...
  factory Transaction.fromJson(Map<String, dynamic> json) => Transaction(
    ...
    tujuanSelanjutnya: json['tujuan_selanjutnya'] is Map ? Map<String, dynamic>.from(json['tujuan_selanjutnya'] as Map) : null,
    namaPenerimaAkhir: json['nama_penerima_akhir'] as String?,
    currentCabangId: json['current_cabang_id'] as String?,
    lokasiPenerima: json['lokasi_penerima'] is Map ? Map<String, dynamic>.from(json['lokasi_penerima'] as Map) : null,
    jenisMasalah: json['jenis_masalah'] as String?,
    catatanMasalah: json['catatan_masalah'] as String?,
    dilaporkanOleh: json['dilaporkan_oleh'] is Map ? Map<String, dynamic>.from(json['dilaporkan_oleh'] as Map) : null,
    dilaporkanPada: json['dilaporkan_pada'] != null ? DateTime.parse(json['dilaporkan_pada'] as String) : null,
    diselesaikanOleh: json['diselesaikan_oleh'] is Map ? Map<String, dynamic>.from(json['diselesaikan_oleh'] as Map) : null,
    ...
    pembayaranDikonfirmasiOleh: json['pembayaran_dikonfirmasi_oleh'] is Map ? Map<String, dynamic>.from(json['pembayaran_dikonfirmasi_oleh'] as Map) : null,
