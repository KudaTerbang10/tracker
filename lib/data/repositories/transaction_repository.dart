...
class TransactionRepository {
  ...
  Future<List<Map<String, dynamic>>> getWajibSetor({required int month, required int year}) async {
    final res = await _api.get(ApiConstants.analyticsWajibSetor, query: {
      'month': month.toString(),
      'year': year.toString(),
    });
    final data = res.data['data'] as List<dynamic>;
