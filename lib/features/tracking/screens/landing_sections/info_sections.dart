...
class AboutSection extends StatelessWidget {
  ...
  Widget _textContent({bool centerAlign = false}) {
    return Column(
      ...
      children: [
        ...
        const Text(
          'Yulis Cargo adalah perusahaan logistik dan pengiriman yang berkomitmen memberikan layanan tercepat, teraman, dan terpercaya. Dengan jaringan cabang yang luas dan teknologi pelacakan real-time, kami memastikan setiap paket Anda sampai di tujuan dengan tepat waktu.',
  ...
  Widget _webLayout() => Row(
    ...
    children: [
      Expanded(flex: 1, child: _image(280)),
      const SizedBox(width: 48),
      Expanded(flex: 1, child: _textContent()),
    ],
  );
}
  ...
  Widget _mobileContent(BuildContext context) => Column(
    ...
    children: [
      _contactItem(
        ...
        'Alamat',
        'Sebrang SPBU Caringin Samping Pahala Kencana Jl. Soekarno-Hatta No.187 B, Babakan Ciparay, Kota Bandung, Jawa Barat 40223',
      ),
      const SizedBox(height: 16),
      _contactItem(
        context,
        Icons.email_rounded,
        'Email',
        'marketing@yulis-cargo.com',
      ),
      const SizedBox(height: 16),
      _contactItem(context, Icons.phone_rounded, 'Telepon', '022-6072356'),
      const SizedBox(height: 16),
      _contactItem(
        context,
            ...
            child: Row(
              ...
              children: [
                _socialButton(
                  ...
                  'Facebook',
                  'https://www.facebook.com/pt.yulis.kargo',
                ),
                _socialButton(
                  Icons.camera_alt_rounded,
                  'Instagram',
                  'https://www.instagram.com/p/DXJRzr1jtsp/?img_index=1',
                ),
              ],
            ),
          ),
...
class FooterSection extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Center(
        child: Text(
          'Â© ${DateTime.now().year} Yulis Cargo. All rights reserved.',
